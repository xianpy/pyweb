 ...
 */
 ...
 $("#register").click(function(e) {
	...
	$("#box").css({"width":"100%","height":"auto","box-shadow":"#666","opacity":"0.4","background":"#666"});
	$(".agreement").css("z-index","10000");
	
});
$("#clear").click(function(e){
	$(".agreement").css("display","none");
	$("#box").css({"width":"100%","height":"auto","opacity":"1","background":"#FFF"});
	$(".agreement").css("z-index","10");
	})
//购物车控制显示
